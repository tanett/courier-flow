...
import { theme } from '../../../../app/providers/with-mantine/theme.config';
            ...
            >
                <Flex className={classes.filterDrawerContainer}>
                    <Flex className={classes.filterDrawerHeader}>
                        ...
                        <ActionIcon onClick={close} variant="outline" size="2.625rem" radius="md" color={ theme.colors!.primary![ 5 ]}>
