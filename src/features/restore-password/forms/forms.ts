...
import { typeFormRestorePassword } from '../types/types';
...
export const InitialRestorePasswordFormObj: typeFormRestorePassword = {
    newPassword: '',
    confirmNewPassword: '',
};

export const initialRestorePasswordForm = {
    initialValues: InitialRestorePasswordFormObj,
    validate: {
        ...
        confirmNewPassword: (value: string, values: typeFormRestorePassword) => {
