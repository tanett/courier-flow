...
export enum PRODUCT_IMPORT_TYPE_FOR_TEMPLATE  {
    PRODUCT_IMPORT_CATALOG='PRODUCT_IMPORT_CATALOG',
    RETAIL_PRODUCT_EXCEL_IMPORT='RETAIL_PRODUCT_EXCEL_IMPORT',
    RETAIL_PRODUCT_FILTER_IMPORT='RETAIL_PRODUCT_FILTER_IMPORT'
}
