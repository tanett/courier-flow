...
import { merchantAdminCodeRole, merchantStoreManagerCodeRole } from '../../role/constants/roles-constants';
import { OrderStatuses } from '../model/orders-statuses';

export const isOrderPossibleToEdit = (order: typeOrder| typeOrdersShortWithCheckBox, currentUser:  typeGetCurrentUserResponse, isAllowedEditByPermission: boolean):boolean=>{
