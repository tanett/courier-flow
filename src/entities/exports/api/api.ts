...
export const exportApi = baseApi.injectEndpoints({
    endpoints: (builder) => ({
        ...
        // // Get export list
        // getExportTerminalList: builder.query<typeSearchResponse<typeExport>, typeSearchRequest<typeSearchExportFilter, typeSearchExportSortingNames>>({
        //     query: (data) => (
        //         {
